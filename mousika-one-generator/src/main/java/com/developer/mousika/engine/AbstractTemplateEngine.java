 ...
 * the License.
 */
package com.developer.mousika.engine;
...
public abstract class AbstractTemplateEngine {
        ...
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                if(null != tableInfo.getDtoName() && null !=pathInfo.get(ConstVal.DTO_PATH)){
                    String dtoFile=String.format((pathInfo.get(ConstVal.DTO_PATH) + File.separator+tableInfo.getDtoName()+this.suffixJavaOrKt()));
                    if (this.isCreate(FileType.DTO,dtoFile)) {
                        this.writer(objectMap, this.templateFilePath(template.getDto()),dtoFile);
                    }
                }
                //MapStruct.java
                if(null != tableInfo.getMapStructName() && null != pathInfo.get(ConstVal.MAP_STRUCT_PATH)){
                    String mapStructFile = String.format(pathInfo.get(ConstVal.MAP_STRUCT_PATH)+File.separator+tableInfo.getMapStructName()+this.suffixJavaOrKt());
                    if(this.isCreate(FileType.MAPSTRUCT,mapStructFile)){
                        this.writer(objectMap,this.templateFilePath(template.getMapStruct()),mapStructFile);
                    }
                }
                // MpMapper.java
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        objectMap.put("superDtoClass", this.getSuperClassName(config.getSuperDtoClass()));
        objectMap.put("superMapStructClass",this.getSuperClassName(config.getSuperMapStructClass()));
